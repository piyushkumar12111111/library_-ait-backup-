...
// Colors
const Color kBlue = Color.fromARGB(255, 42, 153, 244);
const Color kLightBlue = Color.fromARGB(255, 115, 180, 255);
const Color kDarkBlue = Color.fromARGB(255, 58, 105, 186);
